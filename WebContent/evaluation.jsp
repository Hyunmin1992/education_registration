 ...
 <a href='CourseCheck?command=coursesById&studentId=${sessionScope.student.studentId}' class="nav-link text-left">수강 내역</a>
		...
		<table align="center" border="0" cellpadding="5" cellspacing="2"
			...
			<tr>
				...
				<td bgcolor="#336699">
					<p align="center">
						<font color="white"><b><span style="font-size: 13pt;">평가
									내용</span></b></font>
					</p>
				</td>
				<td bgcolor="#336699">
					<p align="center">
						<font color="white"><b><span style="font-size: 13pt;">작성일</span></b></font>
					</p>
				</td>
			</tr>
			...
			<c:if test="${empty list || fn:length(list) == 0}">
				<tr>
					<td colspan="5">
						<p align="center">
							<b><span style="font-size: 13pt;">평가내역이 없습니다.</span></b>
						</p>
					</td>
				</tr>
			</c:if>
			...
			<c:forEach items="${requestScope.list}" var="data">
				<tr>
					...
					<td bgcolor="">
						<p align="center">
							<span style="font-size: 13pt;"> ${data.studentId}</span>
						</p>
					</td>
					<td bgcolor="">
						<p align="center">
					...
					<td bgcolor="">
						<p align="center">
							<span style="font-size: 13pt;">  ${data.evaluationDay}
							</span>
						</p>
					</td>
				</tr>
